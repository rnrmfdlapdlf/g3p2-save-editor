...
export type AbilityCategory = "normal" | "equipped" | "special" | "legionSpecial" | "specialUnlock" | "dummy";
...
export const INVENTORY_CATALOG: InventoryCatalogItem[] = [
  ...
  { code: 107, name: "프레임쉘1", maxLevel: 5, category: "item" as InventoryItemCategory, consumableKind: "green-liquid" as ConsumableKind },
  { code: 113, name: "썬더아이스1", category: "item" as InventoryItemCategory, consumableKind: "green-liquid" as ConsumableKind },
  { code: 116, name: "배틀포이즌1", maxLevel: 10, category: "item" as InventoryItemCategory, consumableKind: "poison" as ConsumableKind },
  ...
  { code: 125, name: "안정제", maxLevel: 1, category: "item" as InventoryItemCategory, consumableKind: "first-aid" as ConsumableKind },
  { code: 126, name: "여신의 성수", maxLevel: 1, category: "item" as InventoryItemCategory, consumableKind: "potion" as ConsumableKind },
  { code: 167, name: "파멸의 폭염1", maxLevel: 1, category: "item" as InventoryItemCategory, consumableKind: "bomb" as ConsumableKind },
  { code: 168, name: "파멸의 폭염2", maxLevel: 1, category: "item" as InventoryItemCategory, consumableKind: "bomb" as ConsumableKind },
  { code: 169, name: "라이징 스톰", maxLevel: 1, category: "item" as InventoryItemCategory, consumableKind: "bomb" as ConsumableKind },
  { code: 170, name: "애스트로 범", maxLevel: 1, category: "item" as InventoryItemCategory, consumableKind: "bomb" as ConsumableKind },
...
export const ABILITY_OPTIONS: AbilityOption[] = [
  { code: 0, name: "연", maxLevel: 20, category: "normal" },
  { code: 1, name: "파", maxLevel: 20, category: "normal" },
  { code: 2, name: "비", maxLevel: 20, category: "normal" },
  { code: 3, name: "살", maxLevel: 20, category: "normal" },
  { code: 4, name: "혼", maxLevel: 20, category: "normal" },
  { code: 5, name: "폭", maxLevel: 20, category: "normal" },
  { code: 6, name: "광", category: "dummy" },
  { code: 7, name: "오버드라이브", maxLevel: 20, category: "normal" },
  { code: 8, name: "힐", maxLevel: 10, category: "normal" },
  { code: 9, name: "격려", maxLevel: 20, category: "normal" },
  { code: 10, name: "큐어", maxLevel: 10, category: "normal" },
  { code: 11, name: "포스필드", maxLevel: 20, category: "normal" },
  { code: 12, name: "희생", maxLevel: 10, category: "normal" },
  { code: 13, name: "오버플로우", maxLevel: 20, category: "normal" },
  { code: 14, name: "리미트 플로우", maxLevel: 20, category: "normal" },
  { code: 15, name: "프레셔", maxLevel: 5, category: "normal" },
  { code: 16, name: "메테오 스트라이크", maxLevel: 10, category: "normal" },
  { code: 17, name: "포스리젼", maxLevel: 10, category: "normal" },
  { code: 18, name: "비연참", maxLevel: 10, category: "normal" },
  { code: 19, name: "소닉 블레이드", maxLevel: 10, category: "normal" },
  { code: 20, name: "풍아열공참", maxLevel: 10, category: "normal" },
  { code: 21, name: "익스플로젼", maxLevel: 10, category: "normal" },
  { code: 22, name: "헤비 프레셔", maxLevel: 5, category: "normal" },
  { code: 26, name: "더블 브레이크", character: "아셀라스", maxLevel: 1, category: "special" },
  { code: 27, name: "소울 블레스트", maxLevel: 20, category: "normal" },
  { code: 28, name: "엘레멘탈 파이어", maxLevel: 20, category: "normal" },
  { code: 29, name: "카운터 블레이드", maxLevel: 20, category: "normal" },
  { code: 30, name: "블레이드 미사일", maxLevel: 20, category: "normal" },
  { code: 31, name: "사신의 분노", legion: "바루스 슬레이어", maxLevel: 1, category: "legionSpecial" },
  { code: 33, name: "일루션히트", maxLevel: 20, category: "normal" },
  { code: 34, name: "소울 스트라이크", maxLevel: 20, category: "normal" },
  { code: 35, name: "마인드 어택", maxLevel: 20, category: "normal" },
  { code: 36, name: "하이 텔레포트", maxLevel: 20, category: "normal" },
  { code: 37, name: "텔레파시", category: "dummy" },
  { code: 38, name: "쇼크", maxLevel: 10, category: "normal" },
  { code: 39, name: "브레인스톰", maxLevel: 10, category: "normal" },
  { code: 40, name: "배리어", maxLevel: 20, category: "normal" },
  { code: 41, name: "아디지오", maxLevel: 5, category: "normal" },
  { code: 42, name: "프레스토", maxLevel: 5, category: "normal" },
  { code: 43, name: "퍼니피", category: "dummy" },
  { code: 44, name: "리미트 크래쉬", maxLevel: 10, category: "normal" },
  { code: 45, name: "리미트 캐스트", maxLevel: 10, category: "normal" },
  { code: 46, name: "마인드 컨트롤", maxLevel: 5, category: "normal" },
  { code: 47, name: "마인드 체인지", maxLevel: 5, category: "normal" },
  { code: 48, name: "파워드배리어", maxLevel: 10, category: "normal" },
  { code: 49, name: "브레인 브레이크", maxLevel: 10, category: "normal" },
  { code: 50, name: "일루션 컨트럴", category: "dummy" },
  { code: 51, name: "오버테이크", maxLevel: 5, category: "normal" },
  { code: 52, name: "올퍼니피", category: "dummy" },
  { code: 53, name: "익스퍼트 웨이브", maxLevel: 10, category: "normal" },
  { code: 54, name: "익스퍼트 블레스트", maxLevel: 10, category: "normal" },
  { code: 55, name: "엘레멘탈 아이스", maxLevel: 20, category: "normal" },
  { code: 56, name: "엘레멘탈 썬더", maxLevel: 20, category: "normal" },
  { code: 57, name: "엘레멘탈 라이트", maxLevel: 20, category: "normal" },
  { code: 58, name: "리인카네이션", maxLevel: 10, category: "normal" },
  { code: 59, name: "서몬 몬스터", maxLevel: 20, category: "normal" },
  { code: 60, name: "리콜", maxLevel: 10, category: "normal" },
  { code: 61, name: "엘레멘탈 실드", maxLevel: 5, category: "normal" },
  { code: 62, name: "엘레멘탈 라이트닝", category: "dummy" },
  { code: 63, name: "엘레멘탈 다크", maxLevel: 20, category: "normal" },
  { code: 64, name: "하드 밸런싱", maxLevel: 20, category: "normal" },
  { code: 65, name: "소프트 밸런싱", maxLevel: 20, category: "normal" },
  { code: 66, name: "엘레멘탈 베이스", maxLevel: 10, category: "normal" },
  { code: 68, name: "락킹필드", maxLevel: 5, category: "normal" },
  { code: 69, name: "포이즌", maxLevel: 10, category: "normal" },
  { code: 70, name: "기가실드", maxLevel: 5, category: "normal" },
  { code: 71, name: "파이어웨 이브", maxLevel: 10, category: "normal" },
  { code: 72, name: "라이트닝 샤벨", maxLevel: 10, category: "normal" },
  { code: 73, name: "어스퀘이크", maxLevel: 10, category: "normal" },
  { code: 74, name: "썬더스톰", maxLevel: 10, category: "normal" },
  { code: 75, name: "블리자드", maxLevel: 10, category: "normal" },
  { code: 76, name: "카운터 스피어", maxLevel: 20, category: "normal" },
  { code: 77, name: "카운터 미사일", maxLevel: 20, category: "normal" },
  { code: 78, name: "아스트럴 파이어", maxLevel: 20, category: "normal" },
  { code: 79, name: "엘레멘탈 버스터", maxLevel: 20, category: "normal" },
  { code: 80, name: "웨폰 크래쉬", maxLevel: 5, category: "normal" },
  { code: 81, name: "에네르기힐", category: "dummy" },
  { code: 82, name: "아스트럴 실드", maxLevel: 20, category: "normal" },
  { code: 83, name: "사이킥 크로스", maxLevel: 10, category: "normal" },
  { code: 84, name: "캐노피", maxLevel: 10, category: "normal" },
  { code: 85, name: "피드백", maxLevel: 10, category: "normal" },
  { code: 86, name: "아스트럴 애로우", maxLevel: 10, category: "normal" },
  { code: 87, name: "아스트럴 블레이드", maxLevel: 10, category: "normal" },
  { code: 88, name: "카운터붐", maxLevel: 10, category: "normal" },
  { code: 89, name: "파이널 버스터", maxLevel: 10, category: "normal" },
  { code: 90, name: "아스트럴 필드", maxLevel: 10, category: "normal" },
  { code: 91, name: "리바이블", maxLevel: 5, category: "normal" },
  { code: 92, name: "와이드힐", category: "normal" },
  { code: 93, name: "크래쉬붐", maxLevel: 20, category: "normal" },
  { code: 94, name: "메테오", maxLevel: 20, category: "normal" },
  { code: 95, name: "다이나믹 크래쉬", maxLevel: 20, category: "normal" },
  { code: 96, name: "커스", maxLevel: 10, category: "normal" },
  { code: 97, name: "카운터 실드", maxLevel: 20, category: "normal" },
  { code: 98, name: "워큰드 아머", maxLevel: 15, category: "normal" },
  { code: 99, name: "파워드 아머", maxLevel: 15, category: "normal" },
  { code: 100, name: "파워 다운", maxLevel: 15, category: "normal" },
  { code: 101, name: "파워 업", maxLevel: 15, category: "normal" },
  { code: 102, name: "스피드 업", maxLevel: 15, category: "normal" },
  { code: 103, name: "스피드 다운", maxLevel: 15, category: "normal" },
  { code: 104, name: "페스트렉", maxLevel: 15, category: "normal" },
  { code: 105, name: "카피렉", maxLevel: 15, category: "normal" },
  { code: 106, name: "블라인드", maxLevel: 5, category: "normal" },
  { code: 107, name: "안티 벨런싱", maxLevel: 5, category: "normal" },
  { code: 108, name: "코메트", category: "dummy" },
  { code: 109, name: "그라비티 필드", maxLevel: 10, category: "normal" },
  { code: 110, name: "그라비티 벨런스", maxLevel: 10, category: "normal" },
  { code: 111, name: "블레이드 샤워", maxLevel: 10, category: "normal" },
  { code: 112, name: "카운터 필드", maxLevel: 10, category: "normal" },
  { code: 113, name: "언벨런싱", category: "dummy" },
  { code: 114, name: "블랙홀", maxLevel: 10, category: "normal" },
  { code: 115, name: "미라클", maxLevel: 1, category: "normal" },
  { code: 116, name: "워핑", maxLevel: 10, category: "normal" },
  { code: 117, name: "방어", category: "normal" },
  { code: 118, name: "회피", category: "normal" },
  { code: 121, name: "오메가 스윙", character: "샤크바리", maxLevel: 1, category: "special" },
  { code: 122, name: "공폭탄", category: "normal" },
  { code: 123, name: "헬카이트", category: "normal" },
  { code: 124, name: "Hunter", category: "dummy" },
  { code: 125, name: "크레이지 샷", character: "크리스티앙", maxLevel: 1, category: "special" },
  { code: 126, name: "진 풍아열공참", character: "죠안", maxLevel: 1, category: "special" },
  { code: 127, name: "초능력공격", category: "normal" },
  { code: 138, name: "나인크루세이더", character: "디에네", maxLevel: 1, category: "special" },
  { code: 139, name: "다크스크림", character: "마리아", maxLevel: 1, category: "special" },
  { code: 140, name: "리커버리", category: "normal" },
  { code: 141, name: "리제너레이션", category: "normal" },
  { code: 142, name: "엘레멘탈힐", category: "normal" },
  { code: 143, name: "힐윈드", category: "normal" },
  { code: 144, name: "사이킥 드라이브", character: "아슈레이", maxLevel: 1, category: "special" },
  { code: 145, name: "셰틀라이트 어택", character: "크리스티앙", maxLevel: 1, category: "special" },
  { code: 146, name: "버닝웜", character: "란", maxLevel: 1, category: "special" },
  { code: 147, name: "타이타니아 슈발츠", character: "유진", maxLevel: 1, category: "special" },
  { code: 148, name: "코메트", category: "normal" },
  { code: 149, name: "페이온 스피리츠", character: "리엔", maxLevel: 1, category: "special" },
  { code: 150, name: "무신멸뢰옥", character: "유진", maxLevel: 1, category: "special" },
  { code: 151, name: "LP 증가", maxLevel: 10, category: "equipped" },
  { code: 154, name: "SOUL 증가", maxLevel: 10, category: "equipped" },
  { code: 155, name: "DEP 증가", maxLevel: 10, category: "equipped" },
  { code: 156, name: "TP 증가", maxLevel: 10, category: "equipped" },
  { code: 157, name: "PSY 증가", maxLevel: 10, category: "equipped" },
  { code: 158, name: "인페르노", character: "엠블라", maxLevel: 1, category: "special" },
  { code: 159, name: "폭주", character: "베라모드", maxLevel: 1, category: "special" },
  { code: 160, name: "이스케이프", maxLevel: 1, category: "normal" },
  { code: 161, name: "레이져공격", category: "dummy" },
  { code: 162, name: "천지파열무", character: "살라딘", maxLevel: 1, category: "special" },
  { code: 163, name: "진무 천지파열", character: "살라딘", maxLevel: 1, category: "special" },
  { code: 164, name: "아수라파천무", character: "베라모드, 살라딘", maxLevel: 1, category: "special" },
  { code: 165, name: "빅뱅", character: "리챠드", maxLevel: 1, category: "special" },
  { code: 166, name: "밍밍 스페셜", character: "네리사", maxLevel: 1, category: "special" },
  { code: 167, name: "선 블래스트", character: "란", maxLevel: 1, category: "special" },
  ...
  { code: 175, name: "대검연마법", character: "유진", maxLevel: 3, category: "specialUnlock" },
  { code: 176, name: "광마육혈포", character: "크리스티앙", maxLevel: 3, category: "specialUnlock" },
  { code: 177, name: "반사광증폭", character: "란", maxLevel: 3, category: "specialUnlock" },
  { code: 178, name: "구룡금나수", character: "리엔", maxLevel: 3, category: "specialUnlock" },
  { code: 179, name: "발키리의 혼", character: "죠안", maxLevel: 3, category: "specialUnlock" },
  { code: 180, name: "루나무음보법", character: "마리아", maxLevel: 3, category: "specialUnlock" },
  { code: 181, name: "기자근성", character: "루시엔", maxLevel: 3, category: "specialUnlock" },
  { code: 182, name: "밍밍 조련술", character: "네리사", maxLevel: 3, category: "specialUnlock" },
  { code: 183, name: "머독 폭파술", character: "리차드", maxLevel: 3, category: "specialUnlock" },
  { code: 184, name: "화령 제렴술", character: "엠블라", maxLevel: 3, category: "specialUnlock" },
  { code: 185, name: "템페스트", character: "리차드", legion: "슈&진", maxLevel: 1, category: "legionSpecial" },
  { code: 186, name: "회색의 잔영", legion: "메트로스 삼인방", maxLevel: 1, category: "legionSpecial" },
  { code: 187, name: "강림의 밤", legion: "영 페이온", maxLevel: 1, category: "legionSpecial" },
  { code: 188, name: "서풍의 광시곡", legion: "카를로스 친위대", maxLevel: 1, category: "legionSpecial" },
  { code: 189, name: "레드 크로스", legion: "레드해커즈", maxLevel: 1, category: "legionSpecial" },
  { code: 190, name: "아지다하카 전술 MK-Ⅱ", character: "살라딘", legion: "아지다하카", maxLevel: 1, category: "legionSpecial" },
  { code: 191, name: "월광의 살육", character: "마리아", legion: "루나스", maxLevel: 1, category: "legionSpecial" },
  { code: 192, name: "블랙 이클립스", legion: "시즈", maxLevel: 1, category: "legionSpecial" }
];
